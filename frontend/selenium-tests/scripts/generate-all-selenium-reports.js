...
async function main() {
  console.log('Generating Selenium Web E2E Automation Excel report with 305 test cases...');
  ...
  console.log('All 305 Selenium Web Test Cases generated cleanly in Excel & CSV formats!');
}
